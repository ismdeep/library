...
download_detail() {
  ...
  if [ ! -f "${target_folder}/${name}" ]; then
    tmp_dir="${HOME}/.lemuria/download/$(openssl rand -hex 16)"
    mkdir -p "${tmp_dir}"
  ...
  echo -e "==> ${target_folder}/${name} \e[42mOK\e[0m"
  rm -rf "${tmp_dir}"
}
...
v1.23.0 v1.23.1 v1.23.2 v1.23.3 v1.23.4 v1.23.5 v1.23.6 v1.23.7 v1.23.8 v1.23.9 v1.23.10 v1.23.11 v1.23.12 v1.23.13 v1.23.14 v1.23.15 v1.23.16 \
v1.24.0 v1.24.1 v1.24.2 v1.24.3 v1.24.4 v1.24.5 v1.24.6 v1.24.7 v1.24.8 v1.24.9 v1.24.10 \
v1.25.0 v1.25.1 v1.25.2 v1.25.3 v1.25.4 v1.25.5 v1.25.6 \
v1.26.0 v1.26.1 \
latest)
